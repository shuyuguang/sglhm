...
// ====================【UI & 交互常量】====================
// ▼▼▼ 新增开始 ▼▼▼
// 将 GENDER_OPTIONS 和 LONG_PRESS_DURATION 从旧的配置文件移到这里
const GENDER_OPTIONS = ['⚲（？）', '♀（女）', '♂（男）'];
const LONG_PRESS_DURATION = 500; // 长按删除预设的延迟时间（毫秒）
// ▲▲▲ 新增结束 ▲▲▲


// ====================【数据库键配置】====================
const PROFILE_DB_KEYS = {
    // 核心数据
...
// 为了方便，提供一个包含所有键的数组
const ALL_PROFILE_DB_KEYS = Object.values(PROFILE_DB_KEYS);