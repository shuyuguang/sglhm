...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    `;
        ...
        appContainer.innerHTML = `<p style="text-align: center; margin-top: 50px;">页面加载失败。无法从数据库获取必要信息。<br>请检查控制台了解详情。</p>`;
    }
    // ▲▲▲ 修改结束 ▲▲▲
});